...
def run_dynamic_crucible():
    file_path = "archive/fractal_manifold_6M.parquet"
    print("[*] AION DYNAMIC CRUCIBLE: Initiating 6-Month Statistical Stress Test...")
    ...
    for i in range(window, len(sensorium)):
        ...
        if i > window:
            # DYNAMIC THRESHOLD: Entropy must drop by > 15% of the current total entropy
    ...
    print("\n" + "="*80)
    print("AION DYNAMIC CRUCIBLE: 6-MONTH STATISTICAL AUDIT")
    print("="*80)
